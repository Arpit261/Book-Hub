...
import adpator.DashboardRecyclerAdapter
...
class DashBoardFragment : Fragment() {
    ...
    lateinit var recycleAdaptor: DashboardRecyclerAdapter
                                   ...
                                   try {
                                       ...
                                       if (success){
                                           ...
                                           for (i in 0 until data.length()){
                                               ...
                                               recycleAdaptor= DashboardRecyclerAdapter(activity as Context , bookInfoList)
                                               recyclerDashboard.adapter=recycleAdaptor
                                       ...
                                       Toast.makeText(activity as Context,"Some unaccepted error occur" , Toast.LENGTH_SHORT).show()
                                   }
